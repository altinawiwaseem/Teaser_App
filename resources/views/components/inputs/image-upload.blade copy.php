...
<div x-data="imageUpload()">
    ...
    <div class="border-2 border-dashed rounded-lg p-8 text-center transition-all duration-200 cursor-pointer"
        ...
        <input x-ref="fileInput" wire:model="{{ $wireModel }}" type="file" accept="{{ $accept }}" class="hidden"
    ...
    <!-- Error Messages -->
    @error($wireModel) <div class="text-red-500 text-sm mt-2">{{ $message }}</div> @enderror
